...
export type GetScheduleQuery = { __typename?: 'Query', Page: { __typename?: 'Page', pageInfo: { __typename?: 'PageInfo', hasNextPage: boolean | null, total: number | null } | null, airingSchedules: Array<{ __typename?: 'AiringSchedule', id: number, episode: number, airingAt: number, media: { __typename?: 'Media', id: number, idMal: number | null, status: MediaStatus | null, season: MediaSeason | null, seasonYear: number | null, format: MediaFormat | null, duration: number | null, episodes: number | null, source: MediaSource | null, countryOfOrigin: any | null, meanScore: number | null, averageScore: number | null, description: string | null, isAdult: boolean | null, bannerImage: string | null, title: (
          { __typename?: 'MediaTitle' }
          & { ' $fragmentRefs'?: { 'MediaTitleFieldsFragment': MediaTitleFieldsFragment } }
