...
export const create = async (guild: Guild, name: string, color: ColorResolvable, hoist: boolean, mentionable: boolean) => {
...
export const update = async (guild: Guild, role: Role, name: string | null, color: ColorResolvable | null, hoist: boolean | null, mentionable: boolean | null, position: number | null) => {
